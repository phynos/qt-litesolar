...
#include "../../../src-qt-ui/notify/notify.h"
...
QT_MOC_LITERAL(1, 7, 11), // "disappeared"
QT_MOC_LITERAL(2, 19, 0) // ""

    },
    "Notify\0disappeared\0"
};
...
void Notify::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->disappeared(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (Notify::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Notify::disappeared)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Notify::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Notify.data,
      qt_meta_data_Notify,  qt_static_metacall, nullptr, nullptr}
};
