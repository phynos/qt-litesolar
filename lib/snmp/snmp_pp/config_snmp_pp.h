...
#define SNMP_PP_VERSION_STRING "3.3.0"
...
#endif
#if 1		//HAVE_LIBTOMCRYPT must be enabled
#define HAVE_LIBTOMCRYPT 1
#endif
#if 0		//HAVE_LIBDES must be disabled
...
#ifdef __MINGW32__ //cwenfu _MSC_VER ->__MINGW32__
